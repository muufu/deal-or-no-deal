...
export function BankerMascot({ size = 200, style = 'mascot' }: Props) {
  ...
  return (
    <svg viewBox="0 0 200 240" width={size} style={{ overflow: 'visible' }}>
      <defs>
        <radialGradient id="bodyGrad" cx="0.4" cy="0.4" r="0.6">
          <stop offset="0%" stopColor="#5a8eff" />
          <stop offset="100%" stopColor="#1a3aa0" />
        </radialGradient>
        <radialGradient id="headGrad" cx="0.4" cy="0.4" r="0.6">
      ...
      <ellipse cx="100" cy="170" rx="62" ry="55" fill="url(#bodyGrad)" />
      <ellipse cx="100" cy="180" rx="40" ry="38" fill="url(#bellyGrad)" />
      ...
      <circle cx="100" cy="80" r="48" fill="url(#headGrad)" />
      ...
      <ellipse cx="148" cy="120" rx="16" ry="22" fill="url(#bodyGrad)" transform="rotate(-20 148 120)" />
      ...
      <ellipse cx="48" cy="170" rx="14" ry="20" fill="url(#bodyGrad)" />
